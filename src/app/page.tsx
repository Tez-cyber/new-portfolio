    ...
    <section className="bg-[#0d0d0d] text-textPrimary w-full md:w-screen min-h-screen p-5 flex flex-col items-center justify-center">
      ...
      <div className="grid gap-4 h-full lg:grid-cols-[70%_28.5%] border-[2px] border-solid border-textPrimary/30 p-4 rounded-3xl">
        ...
        <div className="bg-tipsyDark text-textPrimary px-10 py-5 rounded-2xl">
          {/* Nsexpress */}
          <div className="">
            <a href="https://nsdigitals.com.ng/" className="flex items-center justify-between group">
              <p>Nsexpress</p>
          ...
          <div className="my-5">
            <a href="https://www.turftriibe.com/" target="_blank" className="flex items-center justify-between group">
              <p>Turftriibe</p>
          ...
          <span className="mt-5 rounded-2xl w-full h-[1px] bg-textPrimary block" />
          <div className="my-5">
            <a href="https://aura-auction-sigma.vercel.app/" target="_blank" className="flex items-center justify-between group">
              <p>AuraBid</p>
              <FaArrowRightLong className="group-hover:-rotate-45 transition-all duration-200 ease-in" />
            </a>
          </div>
